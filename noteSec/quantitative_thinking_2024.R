...
load("C:/Users/fakeghost/Downloads/RProject-master/RProject-master/noteSec/lj_sh_2019.RData")
...
lj %>% mutate(property_name = as.factor(property_name))
...
# (1) Plot age(2020-building_year) vs. building_area with geom_point(). Put building_area on the y axis. 
lj %>% 
        mutate(building_age=(2020-building_year)) %>% 
        ggplot() +
...
t.test(immer$Y1,immer$Y2,var.equal = FALSE)
# Loc Var    Y1    Y2 
# 1  UF   M  81.0  80.7 
# 2  UF   S 105.4  82.3 
# .....
